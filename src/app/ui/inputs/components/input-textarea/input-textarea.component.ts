...
@Component({
  selector: 'combo-input-textarea',
  templateUrl: './input-textarea.component.html',
  styleUrls: ['./input-textarea.component.css'],
})
export class InputTextareaComponent extends InputSchema implements OnInit, OnDestroy {
  ...
  @Output() $secondCustomLogicInput: EventEmitter<any> = new EventEmitter<any>();
